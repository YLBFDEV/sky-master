...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    protected void onRefreshing(final boolean doScroll) {
        /**
         * If we're not showing the Refreshing views, or the list is empty, the
    ...
    protected ListView createRefreshableView(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.PullToRefresh);
        int dividerHeight = typedArray.getDimensionPixelSize(R.styleable.PullToRefresh_dividerHeight, 0);
        ListView lv = createListView(context, attrs);

        // Set it to this so it can be used in ListActivity/ListFragment
        lv.setId(android.R.id.list);
     // lv.setSelector(R.drawable.btn_selector);
    ...
    public long[] getCheckItemIds() {
        return mRefreshableView.getCheckedItemIds();
    }
