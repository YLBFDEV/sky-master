...
public interface IPullToRefresh<T extends View> {
	...
	/**
	 * Get the mode that this views is currently in. This is only really useful
	 * when using <code>Mode.BOTH</code>.
	 * 
	 * @return Mode that the views is currently in
	 */
	...
	/**
	 * Get the mode that this views has been set to. If this returns
	 * <code>Mode.BOTH</code>, you can use <code>getCurrentMode()</code> to
	 * check which mode the views is currently in
	 * 
	 * @return Mode that the views has been set to
	 */
	public PullToRefreshBase.Mode getMode();

	/**
	 * Get the Wrapped Refreshable View. Anything returned here has already been
	 * added to the content views.
	 * 
	...
	/**
	 * Set the mode of Pull-to-Refresh that this views will use.
	 * 
	 ...
	 * show the 'Refreshing' views, and be scrolled to show such.
	 */
	public void setRefreshing();

	/**
	 * Sets the Widget to be in the refresh state. The UI will be updated to
	 * show the 'Refreshing' views.
	 * 
