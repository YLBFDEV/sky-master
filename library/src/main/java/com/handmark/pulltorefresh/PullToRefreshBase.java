...
import com.handmark.pulltorefresh.internal.*;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    /**
     * Used internally for adding views. Need because we override addView to
     ...
     * <p/>
     * Be sure to set the ID of the views in this method, especially if you're
     * using a ListActivity or ListFragment.
     *
     * @param context Context to create views with
    ...
    public static enum AnimationStyle {
         ...
         * inflating the views from XML where the mode is given through a attr
         * int.
         *
    ...
    public static enum Mode {
        ...
        // The modeInt values need to com those from attrs.xml
        Mode(int modeInt) {
            mIntValue = modeInt;
        }
