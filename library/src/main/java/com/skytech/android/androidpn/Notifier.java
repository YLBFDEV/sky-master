...
public class Notifier {
    private static final String ACTION_AFFAIR_CENTER = "com.skytech.wwoa.Notification";

    private static final String ACTION_FORM_KEY = "form_key";

    private static final String ACTION_FORM = "Notifier";
        ...
        if (isNotificationEnabled()) {
         ...
         /*   Intent intent = new Intent(context,
            ...
            if (uri != null
                ...
                intent = new Intent(ACTION_AFFAIR_CENTER);
                intent.putExtra(ACTION_FORM_KEY, ACTION_FORM);
            }
            //Activity不会被重复创建
            intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
