...
public class NotificationService extends Service {
    ...
    public static final String SERVICE_NAME = "com.skytech.android.NotificationService";
    ...
    public void onCreate() {
        ...
        xmppManager.setPassword(SkyInitializer.getInstance().getDeviceId());
        xmppManager.setUsername(SkyInitializer.getInstance().getDeviceId());
    ...
    public static Intent getIntent() {
        ...
        intent.setAction(SERVICE_NAME);//你定义的service的action
        intent.setPackage(SkyInitializer.getInstance().getPackageName());
        return intent;
    }
