...
public class ArkBaseDialog extends Dialog {
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder setTitleIcon(int title_icon) {
        ...
        public ArkBaseDialog create() {
            ...
            ((TextView) layout.findViewById(R.id.dialog_title_show)).setText(title);
            ...
            if (0 != title_icon) {
                (layout.findViewById(R.id.dialog_title_icon)).setBackgroundResource(title_icon);
            }
            ...
            if (negativeButtonText != null) {
                ...
                ((Button) layout.findViewById(R.id.dialog_cancel_btn))
                        .setWidth(104 + (negativeTextLenght - 2) * 15);
                ((Button) layout.findViewById(R.id.dialog_cancel_btn))
            ...
            if (message != null) {
                ...
                (layout.findViewById(
                        R.id.dialog_content_show)).setVisibility(View.GONE);
            }
